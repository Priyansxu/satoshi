    ...
    <div className="p-4 flex justify-center items-center">
      <div className="w-full max-w-md backdrop-blur-lg bg-[#AB9FF1] bg-opacity-70 overflow-hidden outline-dashed outline-2 outline-offset-2 outline-[#AB9FF1]/60 rounded-2xl">
        <div className="p-8">
          ...
          <div className="mb-6 bg-white bg-opacity-20 p-6 rounded-lg">
            ...
            <a 
              ...
              className="group flex items-center justify-between w-full bg-white bg-opacity-20 hover:bg-opacity-30 text-white p-4 rounded-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50"
            >
